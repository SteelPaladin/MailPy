'''Created on 25 Apr 2017 - Latest Update: ~~ 16/02/18 ~~
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~NOTES~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Retrive Mail and Login functions fixed using port 993.
Send mail function requires fixing, the module isn't playing nice with the MIME functionality, testing required.
...
def Logon():
    global username,password,success
